...
export interface City {
  ...
  termNote: string;
  /** Tile 03 - the assistant answer layer, as it behaves in THIS market. */
  answerNote: string;
...
export const CITIES: City[] = [
  {
    ...
    answerNote: "The citation base across Wellington County is thin - very few management firms here are listed properly anywhere beyond Google. That is an advantage rather than a problem: when an owner asks an assistant who manages rental property near Erin, there is very little for it to draw on, and a complete, consistently cited profile becomes the answer almost by default.",
  ...
  },
  {
    ...
    sub: "Orangeville is the seat of Dufferin County and the hub of the Headwaters, right next door to home base. Steady commuter-belt growth means a steady supply of investor-owners with a unit to hand over. I rebuild Orangeville property management profiles against the firms above them, then hold the position.",
  ...
  },
  {
    ...
    answerNote: "Bolton confuses machines the way it confuses people: it is a community inside the Town of Caledon inside the Region of Peel, and an assistant asked who manages property in Bolton frequently returns Brampton and Vaughan firms because the service area was never mapped properly. Getting the geography stated correctly is worth more here than another ten reviews.",
  ...
  },
  {
    ...
    sub: "Guelph is minutes from home base and one of the strongest rental markets in the region, because a university city runs on investor-owned housing. Constant turnover, constant placement work, and a lot of owners who live elsewhere. I rebuild Guelph property management profiles against the firms above them, then hold the position.",
    ...
    answerNote: "University cities generate a specific assistant query that almost nobody optimises for: a parent, out of province, asking who manages student housing in Guelph before a September move. That answer is assembled from citations and reviews rather than a map pack, because the person asking is nowhere near the city and Google knows it.",
  ...
  },
  {
    ...
    sub: "Mississauga is the largest city in the GTA after Toronto and carries both sides of this business at once - a deep investor-owned rental base, and one of the densest concentrations of condominium corporations in the country. I rebuild Mississauga firms against the field above them from my Headwaters base.",
  ...
  },
  {
    ...
    q2: "Vaughan carries an unusually high ratio of condominium corporations to rental doors compared with the rest of this list, which shifts where the value sits. In a rental-heavy market the ranking earns its place through owner enquiries. Here a meaningful share of the return is defensive - it is what a selection committee finds at nine in the evening when it is deciding which three firms receive the package.",
  },
  {
  ...
  },
  {
    ...
    sub: "Newmarket anchors the northern GTA along the Yonge corridor - a steady family-rental market with real local search intent and a field that is competitive but beatable. I rebuild Newmarket property management profiles against the field above them from my Headwaters base.",
    ...
    answerNote: "Corridor markets confuse assistant answers in a specific way: asked who manages rental property in Aurora, an assistant will frequently return Newmarket and Richmond Hill firms without explaining why. That is fine if you are one of the firms it names and fatal if you are not, and what decides it is whether the service area has been declared consistently everywhere the firm appears, not only on Google.",
  ...
  },
  {
    ...
    sub: "Moncton is the Hub City of the Maritimes, and it is a market I have worked firsthand. From my Ontario base I run the same method on Greater Moncton, on the same Rank Lock.",
    mapH2: "The Hub City, and Greater Moncton.",
    mapPara: "Moncton, with Dieppe and Riverview, forms the commercial hub of Atlantic Canada - bilingual, growing, and the retail and distribution centre for the region. Rental demand has climbed hard with the population. I have worked property management in this market, which means I know the field firsthand rather than only the method.",
    compNote: "Greater Moncton is a real, growing market with a field still catching up on local search. Early, complete, well-reviewed profiles take the pack, and most of the field has not built one yet.",
    ...
    q1: "No. Moncton is a market I have worked firsthand rather than one I am describing from a distance. I work firms across Canada and into the United States from an Ontario base, and the work is delivered to your Google profile, so the distance does not decide it.",
    q2: "Moncton is early in a way no Ontario market is. The field is still catching up on local search, the citation base is thin, and the bilingual layer is almost entirely unclaimed - so the same work meets far less resistance here than it does in Brampton. That window closes as the market matures, which is an argument for moving now rather than a promise that it stays open.",
  },
];
...
export function locFaq(c: City): [string, string][] {
  ...
  return [
    ...
    [
      ...
      `The same everywhere. ${RANK_LOCK} I do not promise a number of doors - that depends on your fees, your close rate and your capacity.`,
    ],
  ];
}
