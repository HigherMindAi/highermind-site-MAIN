...
export const CITIES: City[] = [
  {
    ...
    sub: 'Erin is home base. I run the exact Local Ranking System on firms here that I run across Canada - engineered into the top 3 of Google Maps, measured on a locked heatmap, and held to the 60-day guarantee. Small market, real proximity weight, home turf I know cold.',
  ...
  },
  {
    ...
    sub: 'Orangeville is the seat of Dufferin County and the hub of the Headwaters - right next door to home base. I rank Orangeville firms into the top 3 of Google Maps and keep them there, on the same guarantee I run everywhere.',
    mapH2: 'The hub of the Headwaters.',
    mapPara: 'Orangeville sits at the centre of Dufferin County, anchored by its historic Broadway main street and steady commuter-belt growth. It is home turf - I work firms across Orangeville, Mono, and Shelburne the same way I work my own profile. Tight enough a market that a complete, well-reviewed listing pulls real weight.',
  ...
  },
  {
    ...
    sub: 'Bolton sits in Caledon where the GTA meets the countryside, and Caledon is squarely in my home service area. I rank Bolton firms into the top 3 of Google Maps on the same 60-day guarantee.',
    mapH2: 'Bolton & Caledon.',
    mapPara: 'Bolton is the largest community in Caledon, tucked into the Humber valley on the edge of the GTA. Caledon is part of my home service area, so this is familiar ground - a fast-growing market with strong demand for legal services, and a field of small firms that is still very winnable.',
  ...
  },
  {
    ...
    sub: 'Guelph is minutes from home base - a tight-knit university city with a strong local-first streak. I rank Guelph firms into the top 3 of Google Maps and keep them there.',
  ...
  },
  {
    ...
    sub: 'Brampton is one of the largest and fastest-growing cities in the country, and one of the most competitive local markets there is. I rank Brampton firms into the top 3 of Google Maps from my Headwaters base - the system is the same, the field is just deeper.',
    mapH2: 'A big, competitive market.',
    mapPara: 'Brampton is huge, young, and among the most diverse cities in Canada, with enormous demand for legal services and a crowded field of firms chasing it. You do not need an agency inside the city - you need someone who can rank the pin you already have, against real competition. That is the job, and it is delivered to your profile, not from a local office.',
  ...
  },
  {
    ...
    sub: 'Vaughan - Woodbridge, Maple, Concord, Kleinburg - is home to a dense field of law firms in York Region. I rank Vaughan firms into the top 3 of Google Maps from my Headwaters base.',
    mapH2: "York Region's legal market.",
    mapPara: 'Vaughan packs a lot of home-services and construction firms into Woodbridge, Maple, Concord, and Kleinburg, anchored by the fast-growing Vaughan Metropolitan Centre. Strong demand, strong competition - the firms that rank are the ones running their profile like the asset it is.',
    compNote: 'Vaughan is dense with firms, so the field is competitive but the prize is large. Precise category, proximity, and review velocity decide who shows in the pack.',
  },
  {
    ...
    sub: 'Oakville is an affluent lakeside market where clients expect quality and check before they call. I rank Oakville firms into the top 3 of Google Maps from my Headwaters base.',
    ...
    compNote: 'Oakville clients vet before they retain. Rating, reviews, and a complete profile carry outsized weight - which rewards doing the trust work properly.',
  },
  {
    ...
    sub: 'Newmarket anchors the northern GTA along the Yonge corridor. I rank Newmarket firms into the top 3 of Google Maps from my Headwaters base.',
  ...
  },
  {
    ...
    sub: 'Moncton is the Hub City of the Maritimes - and I already work with firms here. From my Ontario base I run the same Local Ranking System on Greater Moncton, on the same 60-day guarantee.',
    mapH2: 'The Hub City, and Greater Moncton.',
    mapPara: 'Moncton, with Dieppe and Riverview, forms the commercial hub of Atlantic Canada - bilingual, growing, and the retail and distribution centre for the region. I already rank firms here, which means I know the market firsthand, not just the method. Local SEO is delivered to your profile, so distance is no barrier - the proof is already on the ground.',
...
export function locFaq(c: City): [string, string][] {
  ...
  let q2: string;
  if (c.region === 'NB') {
    q1 = `No - and ${city} is not theoretical for me. I already work with firms in the ${city} area, so I know the market firsthand. Local SEO is delivered to your Google profile, so distance is no barrier to ranking you.`;
    ...
    q1 = `No. I work with firms across Canada and ${city} is one of them. Local SEO is delivered to your Google profile, so I do not need to be in the building to rank you in it.`;
  ...
  return [
    [`Do you only work with firms in ${city}?`, q1],
