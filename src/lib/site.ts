...
export const BIZ_NAME = 'HigherMindAI - Digital Marketing Solutions';
export const BRAND = 'HigherMindAI';
export const PHONE_DISP = '647-242-5800';
export const PHONE_E164 = '+16472425800';
export const EMAIL = 'derek@highermindai.com';
export const ADDRESS_STREET = '185 Gear Ave';
export const POSTAL = 'N0B 1T0';
