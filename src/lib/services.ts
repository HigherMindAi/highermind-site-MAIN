...
export const SERVICES: ServiceListItem[] = [
  ...
  },
  {
    slug: 'website-build',
    name: 'Website Build',
    line: 'Not a brochure - a salesperson. A fast, conversion-built site that turns the people already searching into calls.',
    flag: false,
  },
  {
  ...
  },
  {
    slug: 'paid-growth',
    name: 'Paid Growth',
    line: 'Engineered ad funnels built on the language your real customers use. Spend that compounds into pipeline, not a gamble.',
    flag: false,
  },
];
